...
const ForgotPassword = () => {
  ...
  return (
    ...
    <div className='w-[40%] self-center m-auto rounded-lg bg-white px-20 py-10 shadow-xl'>
      <img src={resetPassword} alt="Reset Password"  className="w-[100px] h-[100px] object-center m-auto" />
      
      <div className="flex flex-col gap-2 text-center">
          <h1 className="m-0 text-xl font-semibold">Forgot your Password ?</h1>
          <p className="font-thin">Enter your email so that we can send you a reset link.</p>
      </div>
      <form >
        <input
          type="email"
      ...
      <div className="flex flex-col gap-2 text-center mt-2">
        <p className="font-semibold cursor-pointer self-center"  onClick={() => navigate("/login")}> Back to Login </p>
      </div>
    </div>
    </div>
  )
